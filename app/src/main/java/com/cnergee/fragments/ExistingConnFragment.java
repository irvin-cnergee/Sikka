...
//							ISPId = ConfirmationDetails.getISPId();
//							IsPostPaid=ConfirmationDetails.getIsPostPaid();
...
//						while (rslt == "START") {
//							try {
//								Thread.sleep(10);//***********ends here********************************GetMemeberDetails ends here********************************
//
...
public class ExistingConnFragment extends Fragment {
    ...
    protected class ValidUserWebService extends AsyncTask<String, Void, Void> implements OnCancelListener {
        ...
        protected void onPostExecute(Void unused) {
            ...
            //btnsubmit.setClickable(true);
            validUserWebService = null;
            Utils.log(""," getAuthcount: "+getAuthcount);

            if (rslt.trim().equalsIgnoreCase("ok")) {
                Utils.log(""," getAuthcount1: "+getAuthcount);
