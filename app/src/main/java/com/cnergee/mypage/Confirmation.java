...
public class Confirmation extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editor.commit();
                ...
                Log.e("C:",sharedPreferences.getString("EmailId", "0"));
		...
		protected void onPostExecute(Void unused) {
			...
			Dialog.dismiss();
				...
				if (mapConfirmationDetails != null) {
					...
					edit.putString("IsPostPaid",ConfirmationDetails.getIsPostPaid());
					edit.putString("ISPId",ConfirmationDetails.getISPId());
                    edit.putString("EmailId",ConfirmationDetails.getEmailId());

                    edit.commit();
                    Utils.log("doInBackGround getCustomerCareNumber","is:"+ConfirmationDetails.getEmailId());
