...
String data;
int resource_id;
	public GridSpeedAdapter(Context context, int textViewResourceId,
			ArrayList<Speed> alNumbers,String data) {
	...
	@Override
		...
		Speed spd=(Speed)this.getItem(position);
		if(convertView==null){
		...
		holder.tvNumber.setText(spd.getSpeed_Value());
