...
public class MakeMyPaymentsAtom extends Activity {
    ...
    public static String TAG = "MakeMyPaymentAtom";
    Context ctx;
    ...
    private GetAtomSignatureLive atomsignature = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.log("IsChangePlan", "is: " + bundle.getString("datafrom"));
        Utils.log("PackageName", "is: " + bundle.getString("PackageName"));
        Utils.log("PackageAmount", "is: " + bundle.getString("PackageAmount"));
        Utils.log("PackageValidity", "is: " + bundle.getString("PackageValidity"));
        Utils.log("UpdateFrom", "is: " + bundle.getString("updateFrom"));

        Utils.log("AdditionalAmt", "Amount: " + additionalAmount.getFinalcharges());
        Utils.log("AdditionalAmt", "Action: " + additionalAmount.getAdditionalAmountType());
        Utils.log("AdditionalAmt", "Discount: " + additionalAmount.getDiscountPercentage());

        BaseApplication.getEventBus().register(this);

        if (bundle.getString("datafrom").equalsIgnoreCase("changepack")) {
            Utils.log("ChangePackage", "account");
            Changepack = true;
        ...
        linnhome.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                MakeMyPaymentsAtom.this.finish();
        ...
        linnprofile.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                MakeMyPaymentsAtom.this.finish();
                Intent i = new Intent(MakeMyPaymentsAtom.this, Profile.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in_left,
                        R.anim.slide_out_right);
                BaseApplication.getEventBus().post(
        ...
        linnnotification.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                MakeMyPaymentsAtom.this.finish();
                Intent i = new Intent(MakeMyPaymentsAtom.this,
        ...
        linnhelp.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                MakeMyPaymentsAtom.this.finish();
                Intent i = new Intent(MakeMyPaymentsAtom.this, HelpActivity.class);
                startActivity(i);
                overridePendingTransition(R.anim.slide_in_left,
                        R.anim.slide_out_right);
                BaseApplication.getEventBus().post(
    ...
    private class GetSignatureFromMerchantServer extends
        ...
        protected void onPreExecute() {
            ...
            mProgressHUD = ProgressHUD.show(MakeMyPaymentsAtom.this, "Loading...",
                    true, true, this);

            // progressDialog = new ProgressDialog(MakeMyPaymentsAtom.this);
        ...
        protected void onPostExecute(String result) {
            ...
            Intent launchIntent = new Intent(MakeMyPaymentsAtom.this, WebViewScreen.class);
    ...
    private void changeTheContentView() {
        if (response != null && response.size() > 0) {
            TextView heading = new TextView(MakeMyPaymentsAtom.this);
    ...
    private void addFieldsToTheMainLayout(String fieldName, String viewHeading) {
        ...
        TextView textView = new TextView(MakeMyPaymentsAtom.this);
    ...
    private class GetAtomSignatureLive extends AsyncTask<String, Void, Void> implements OnCancelListener {
                ...
                if (response != null && response.length() > 0) {
                    try {
                        ...
                        if (mainobjectJson.has("NewDataSet")) {
                            ...
                            showExitAlert("Please try Again \n  We are unable to process your request", MakeMyPaymentsAtom.this);
                        }
                    ...
                    AlertsBoxFactory.showAlert("We are unable to initiate Payment.", MakeMyPaymentsAtom.this);
                }
            } else {
                AlertsBoxFactory.showAlert("We are unable to initiate Payment.", MakeMyPaymentsAtom.this);
            }
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (rslt.trim().equalsIgnoreCase("ok")) {
                ...
                if (TxStatus.equals("SUCCESS")) {
                    ...
                    MakeMyPaymentsAtom.this.finish();
                    Intent intent = new Intent(getApplicationContext(), TransResponse.class);
    ...
    private class RenewalProcessWebService extends
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (rslt.trim().equalsIgnoreCase("ok")) {
				...
				/*
				 * Intent intent = new
				 * Intent(MakeMyPaymentsAtom.this,IONHome.class);
				 * startActivity(intent);
				 */
            } else {
                AlertsBoxFactory.showAlert(rslt, context);
    ...
    public void onBackPressed() {
        ...
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
		/*
		 * Intent i = new Intent(MakeMyPaymentsAtom.this,RenewPackage.class);
    ...
    public void showPaymentDetailsDialog(AdditionalAmount additionalAmount) {
        if (additionalAmount != null) {
            final Dialog dialog = new Dialog(MakeMyPaymentsAtom.this);
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            // tell the Dialog to use the dialog.xml as it's layout description
            ...
            Point size = new Point();
            WindowManager w = ((Activity) MakeMyPaymentsAtom.this)
                    .getWindowManager();
    ...
    public void onFinishEvent(FinishEvent event) {
        ...
        if (MakeMyPaymentsAtom.this.getClass().getSimpleName().equalsIgnoreCase(event.getMessage())) {
            MakeMyPaymentsAtom.this.finish();
        } else {
