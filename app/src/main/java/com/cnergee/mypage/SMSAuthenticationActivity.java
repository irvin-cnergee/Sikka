...
//            Toast.makeText(context, "intent : " +"\n msg : "+intent.getAction(), Toast.LENGTH_LONG).show();
//
//            try{
//
...
//							if(message.getMessageBody().contains("Sikka Broadband")&& message.getMessageBody().contains("OTP")){
...
//									}
//									if(message_split.length>9){
//										countDown.cancel();
//										etPassword.setText(message_split[2]);
//										if(etPassword.getText().length()>0){
//											validUserWebService= new ValidUserWebService();
//											validUserWebService.execute();
//										}
