...
public class ConfirmationSOAP {
	...
	public void setConfirmationDetails(SoapObject response,
		...
		confirmationdetails.setIsPostPaid(response.getPropertyAsString("IsPostPaid").toString());
		confirmationdetails.setISPId(response.getPropertyAsString("ISPId").toString());
		confirmationdetails.setDob(response.getPropertyAsString("DateofBirth").toString());
        confirmationdetails.setEmailId(response.getPropertyAsString("EmailId").toString());
