...
public class GetChatResponseSOAP {
	...
	public String getServerMessage(String Profile_Id,Context ctx){
		...
		try{
			...
			Utils.log("GetChatResponseSOAP common.SOAP request","is: "+androidHttpTransport.requestDump);
			Utils.log("GetChatResponseSOAP common.SOAP response","is: "+androidHttpTransport.responseDump);
			...
			if (envelope.bodyIn instanceof SoapObject) { // SoapObject = SUCCESS
				...
				if (response != null) {
					...
					if (response.getPropertyCount() > 0) {
						Utils.log("GetChatResponseSOAP common.SOAP ","Response count: "+response.getPropertyCount());
