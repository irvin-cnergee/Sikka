...
public class GetServerMessageSOAP {
	...
	public String getServerMessage(String Profile_Id,Context ctx)throws SocketException,SocketTimeoutException,Exception{
		...
		Utils.log("GetServerMessage common.SOAP request","is: "+androidHttpTransport.requestDump);
		Utils.log("GetServerMessage common.SOAP response","is: "+androidHttpTransport.responseDump);
		...
		if (envelope.bodyIn instanceof SoapObject) { // SoapObject = SUCCESS
			...
			if (response != null) {
				...
				if (response.getPropertyCount() > 0) {
					Utils.log("GetServerMessage common.SOAP ","Response count: "+response.getPropertyCount());
					dbAdapter.open();
				...
				if(Boolean.valueOf(tableObj.getPropertyAsString("ChatResponse"))){
					...
					{
						Utils.log("GetServerMessage common.SOAP","OK RESPONSE");
			...
			//	Utils.log("GetServerMessage common.SOAP ","no Response: ");
			}
