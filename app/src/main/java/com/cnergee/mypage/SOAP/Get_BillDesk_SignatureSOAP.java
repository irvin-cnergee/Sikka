...
public class Get_BillDesk_SignatureSOAP {
	...
	public Get_BillDesk_SignatureSOAP(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
                                      String METHOD_NAME) {
	...
	public String getSignature(String MemberId,String Amount,String TrackId) throws SocketException,SocketTimeoutException,Exception {
		...
		try {
			...
			Log.d(this.getClass().getSimpleName()+":","request:"+androidHttpTransport.requestDump);
			Log.d(this.getClass().getSimpleName()+":","response:"+androidHttpTransport.responseDump);
