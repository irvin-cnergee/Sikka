...
public class RenewalSOAPTopup {
	...
	public RenewalSOAPTopup(String WSDL_TARGET_NAMESPACE, String SOAP_URL,
			String METHOD_NAME) {
	...
	public String CallComplaintNoSOAP()throws SocketException,SocketTimeoutException,Exception {
		...
		pi = new PropertyInfo();
		pi.setName("Speed");
		pi.setValue(getPaymentdata().getSpeed());
		pi.setType(String.class);
		request.addProperty(pi);
		
		pi = new PropertyInfo();
		pi.setName("Data");
		pi.setValue(getPaymentdata().getData());
		pi.setType(String.class);
		request.addProperty(pi);
		...
		pi = new PropertyInfo();
		pi.setName("Validity");
		pi.setValue(getPaymentdata().getTopup_validity());
		pi.setType(String.class);
		request.addProperty(pi);
		...
		pi.setValue(getPaymentdata().getDiscount());
		pi.setType(String.class);
		request.addProperty(pi);
		...
		try {
			...
			androidHttpTransport.call(WSDL_TARGET_NAMESPACE + METHOD_NAME,
					envelope);
			Utils.log("Request Topup common.SOAP",":"+androidHttpTransport.requestDump);
			Utils.log("Response Topup common.SOAP",":"+androidHttpTransport.responseDump);
