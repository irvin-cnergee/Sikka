...
public void run() {
		...
		try{
			...
			if(action.equalsIgnoreCase("complaints")){
                ComplaintsFragment.rslt = resetPasswordSOAP.resetPassword(MemberId,MemberLoginId);
                ComplaintsFragment.statusResponseForPwd=resetPasswordSOAP.getResponse();
				}
			...
			if(action.equalsIgnoreCase("complaints")){
                ComplaintsFragment.rslt = "Internet connection not available!!";
				}
			...
			if(action.equalsIgnoreCase("complaints"))
                ComplaintsFragment.rslt = "Invalid web-service response.<br>"+e.toString();
		}
