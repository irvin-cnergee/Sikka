...
public class WebSubPaisaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.log("atom_URL", "is:" + atom_URL);
...
/*
        ...
        pd = ProgressDialog.show(WebSubPaisaActivity.this, "",
    ...
    public void onBackPressed() {
        ...
        final Dialog dialog = new Dialog(WebSubPaisaActivity.this);
        ...
        WindowManager w = ((Activity) WebSubPaisaActivity.this)
                .getWindowManager();
...
/*	public void showExitAlert(String message, Context ctx) {
		...
		dialogButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebSubPaisaActivity.this.finish();
				Intent i = new Intent(WebSubPaisaActivity.this,
						RenewPackage.class);
				dialog.dismiss();
				startActivity(i);
    ...
    public class InsertAfterPayemnt extends AsyncTask<String, Void, Void>
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (rslt.trim().equalsIgnoreCase("ok")) {
                ...
                AlertsBoxFactory.showAlert(rslt, WebSubPaisaActivity.this);
                return;
            }
        }
