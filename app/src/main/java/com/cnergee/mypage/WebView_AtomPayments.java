...
import com.cnergee.fragments.TransResponseAtomFragment;
...
public class WebView_AtomPayments extends AppCompatActivity {
			...
			if (rslt.trim().equalsIgnoreCase("ok")) {
				...
				if (atoms_status.equals("SUCCESS")) {
					...
					*/
                    ...
                    Fragment fragment = new TransResponseAtomFragment();
                    Bundle bundle = new Bundle();
                    bundle.putString("Amount", amount);
                    bundle.putString("statusMsg", statusMsg);
                    bundle.putString("transStatus", atoms_status);
                    bundle.putString("order_id", "" + order_id);
					// intent.putExtra("AuthCode", Authcode_id);
                    bundle.putString("Amount", additionalAmount.getFinalcharges());
                    bundle.putString("order_status", atoms_status);
                    bundle.putString("bank_ref_no", bank_trans);
                    bundle.putString("Track_id", atom_track_id);
