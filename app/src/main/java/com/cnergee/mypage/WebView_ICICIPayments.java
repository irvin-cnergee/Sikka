...
public class WebView_ICICIPayments extends Activity {
...
/*
        ...
        pd = ProgressDialog.show(WebView_ICICIPayments.this, "",
                "Loading. Please wait...", true);

        webView.getSettings().setJavaScriptEnabled(true);
        webView.addJavascriptInterface(new WebView_ICICIPayments.MyJavaScriptInterface(), "HTMLOUT");
    ...
    public void onBackPressed() {
        ...
        final Dialog dialog = new Dialog(WebView_ICICIPayments.this);
        ...
        WindowManager w = ((Activity) WebView_ICICIPayments.this)
                .getWindowManager();
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    new WebView_ICICIPayments.InsertAfterPayemnt().executeOnExecutor(
                            AsyncTask.THREAD_POOL_EXECUTOR, (String) null);
                    Utils.log("InsertPayment", "Insert Pay executed");
                } else {
                    new WebView_ICICIPayments.InsertAfterPayemnt().execute();
                    Utils.log("InsertPayment", "Insert Pay executed");
                }
...
/*	public void showExitAlert(String message, Context ctx) {
		...
		dialogButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebView_ICICIPayments.this.finish();
				Intent i = new Intent(WebView_ICICIPayments.this,
						RenewPackage.class);
				dialog.dismiss();
				startActivity(i);
    ...
    public class InsertAfterPayemnt extends AsyncTask<String, Void, Void>
        ...
        protected void onPreExecute() {
            ...
            mProgressHUD = ProgressHUD
                    .show(WebView_ICICIPayments.this,
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (rslt.trim().equalsIgnoreCase("ok")) {
                ...
                if (atoms_status.equals("SUCCESS")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {new WebView_ICICIPayments.RenewalProcessWebService().executeOnExecutor(
                            AsyncTask.THREAD_POOL_EXECUTOR, (String) null);
                    } else {
                        new WebView_ICICIPayments.RenewalProcessWebService().execute();
                    }
                ...
                AlertsBoxFactory.showAlert(rslt, WebView_ICICIPayments.this);
                return;
            }
        }
