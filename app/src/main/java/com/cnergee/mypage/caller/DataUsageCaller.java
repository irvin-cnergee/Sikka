...
import com.cnergee.fragments.MyappDataUsageFragment;
...
public class DataUsageCaller extends Thread{
	...
	public void run() {
		...
		try {
			...
			MyappDataUsageFragment.rslt = Datasoap.CallSearchMemberSOAP(
						memberid);
            MyappDataUsageFragment.mapdatausage= Datasoap
