...
public class NotificationCaller extends Thread {
	...
	public void run() {
		...
		try{
			...
			NotificationListFragment.rslt = notificationSoap.setNotificationList(MemberId);
            NotificationListFragment.notificationtList = notificationSoap.getNotificationList();
