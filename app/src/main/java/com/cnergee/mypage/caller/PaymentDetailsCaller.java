...
public class PaymentDetailsCaller extends Thread{
	...
	public void run() {
		...
		try {
            ...
            PaymentHistoryFragment.rslt = paymentCollectionSOAP.CallTodaysCollectionSOAP();
            PaymentHistoryFragment.paymentDetails = paymentCollectionSOAP.getPaymentDetails();
