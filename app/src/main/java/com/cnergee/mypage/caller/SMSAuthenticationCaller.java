...
import com.cnergee.fragments.ChangePackageFragment;
	...
	public void run() {
		...
		try {
			...
			if (checkCall.equalsIgnoreCase("complaints")) {
                ComplaintsFragment.rslt = SmsSOAP.CallSMSSOAP(MemberId, OneTimePwd,
						PhoneUniqueId);
                ComplaintsFragment.isVaildUser = SmsSOAP.isValidUser();
			}
			...
			if(checkCall.equalsIgnoreCase("changepack")){
				PackgedetailFragment.rslt = SmsSOAP.CallSMSSOAP(MemberId, OneTimePwd,
						PhoneUniqueId);
				PackgedetailFragment.isVaildUser = SmsSOAP.isValidUser();
			}

			if(checkCall.equalsIgnoreCase("newchange")){
				ChangePackageFragment.rslt = SmsSOAP.CallSMSSOAP(MemberId, OneTimePwd,
						PhoneUniqueId);
                ChangePackageFragment.isVaildUser = SmsSOAP.isValidUser();
			}
