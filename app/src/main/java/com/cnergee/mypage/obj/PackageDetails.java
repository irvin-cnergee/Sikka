...
public class PackageDetails {
	...
	private int is_icici = 0;
	private int is_subpaisa = 0;
...
*/
	...
	public void setIs_icici(int is_icici) {
	...
	public int getIs_subpaisa() {
		return is_subpaisa;
	}

	public void setIs_subpaisa(int is_subpaisa) {
		this.is_subpaisa = is_subpaisa;
	}
}