...
//        if (localName.equals("Table")) {
//            _inTable = true;
//        } else if (localName.equals("PackageFullName")) {
//            _inPlanName = true;
//        } else if (localName.equals("PackageRate")) {
//            _inPackageRate = true;
//        }
////        else if (localName.equals("AreaCode")) {
////            _inAreaCode = true;
...
//            _inPackageValidity = true;
//        }
//        else if (localName.equals("UseType")) {
//            _inServiceTax = true;
//        }
//        else if (localName.equals("PackageId")) {
//            _inPackageId = true;
//        }else if(localName.equals("BillingScheme")){
//            sr_no= true;
//        }else if(localName.equals("PackageDesc")){
//            package_desc= true;
//        }
...
////        }
	...
	public void characters(char[] ch, int start, int length)
		...
		if (_inPlanName) {
			...
			_packageList.setPackagevalidity(Integer.parseInt(chars.toString()));
		}
...
////        }
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (localName.equals("PlanName")) {
            ...
            Log.e("mapPackageList", ":--" +mapPackageList);
            Log.e("mapPackageList1", ":--" +mapPackageList.get(key));
...
//        if (localName.equals("PackageFullName")) {
//            _inPlanName = false;
//        } else if (localName.equals("PackageRate")) {
//            _inPackageRate = false;
//        }
