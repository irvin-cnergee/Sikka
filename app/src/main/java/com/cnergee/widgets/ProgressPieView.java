...
public class ProgressPieView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = a.getDimension(R.styleable.ProgressPieView_strokeWidth1, mStrokeWidth);
        ...
        backgroundColor = a.getColor(R.styleable.ProgressPieView_backgroundColor1, backgroundColor);
